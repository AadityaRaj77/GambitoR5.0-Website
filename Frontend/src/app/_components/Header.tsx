  ...
  return (
    <div className="py-[2rem] pb-[4rem] relative z-1 max-w-[1380px] pt-[3rem] mx-auto flex justify-between items-center">
      ...
      <div className="flex space-x-6">
        {currentUser ? (
          <button className="text-[20px] font-overpass leading-[25px] font-medium  border border-slate-200 rounded-xl bg-white w-[120px]  text-black  h-[45px] active:bg-slate-200 cursor-pointer">
            Dashboard
          </button>
        ) : null}
        {/* <a href="/results">
